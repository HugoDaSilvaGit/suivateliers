...
<?php
	...
	try {
		...
		$responsables=$bd->query("SELECT nom, prenom, numero, nomConnexion FROM `ResponsableAteliers`");
		...
		<div class="container-fluid">
			...
			<table class="table table-striped">
				...
				<tbody>
					...
					<?php foreach( $responsables as $unResponsable ){ ?>
						<tr>
							<td><?php echo $unResponsable[ 'prenom' ]." ".$unResponsable[ 'nom'] ; ?></td>
                            <td><?php echo $unResponsable[ 'numero' ] ; ?></td>
                            <td><?php echo $unResponsable[ 'nomConnexion' ] ; ?></td>
						</tr>
					<?php } ?>
